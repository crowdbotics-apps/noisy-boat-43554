"""
Django settings for noisy_boat_43554 project.
...
ROOT_URLCONF = 'noisy_boat_43554.urls'
...
WSGI_APPLICATION = 'noisy_boat_43554.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_boat_43554 API",
    "DESCRIPTION": "API documentation for noisy_boat_43554 App",
    "VERSION": "v1",
}
